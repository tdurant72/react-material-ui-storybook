  ...
  return (
    <ThemeProvider theme={theme}>
      <AppWrapper>
        ...
        <MainContent pageColor={colors.neutral["50"]}>
          {/* <Navbar title="My app" titleColor="dark" navBorder="primary" /> */}
          <Header />
          <Section
            title="Funding for a Secure Tomorrow"
          ...
          <Section
            ...
            sectionColor={colors.primary["500"]}
            txtColor={colors.neutral["50"]}
          >
